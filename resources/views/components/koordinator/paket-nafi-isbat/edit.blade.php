...
<section class="content">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('paket.update',['id'=>$paket->id,'paket'=>$paket->paket]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-9">
                                <input type="text" name="paket"
                                    value="{{ old('paket')?? number_format($paket->paket) }}" class="form-control @error('paket') is-invalid
