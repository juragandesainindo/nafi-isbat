    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <form action="{{ route('jamaah.update',['id'=>$jamaah->id,'slug'=>$jamaah->slug]) }}" method="post"
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            @enderror" value="{{ old('nama_jamaah')??$jamaah->nama_jamaah }}" placeholder="nama"
                                        required autofocus>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="alamat_jamaah" class="form-control @error('alamat_jamaah') is-invalid
                                                    @enderror"
                                        value="{{ old('alamat_jamaah')??$jamaah->alamat_jamaah }}" placeholder="alamat">
                        ...
                        <div class="form-group mb-3">
                            ...
                            @enderror" value="{{ old('hp_jamaah')??$jamaah->hp_jamaah }}" placeholder="hp" required>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" name="nik" class="form-control @error('nik') is-invalid
                                                    @enderror" value="{{ old('nik')??$jamaah->nik }}"
                                ...
                                <div class="form-group mt-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        <select class=" form-select" name="user_id" id="pemimpin" required>
                                            <option value="{{ $jamaah->user->id }}">{{ $jamaah->user->title }} {{
                                                $jamaah->user->name }}</option>
                                ...
                                <div class="form-group mt-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        <select class="form-select" name="wilayah_id" id="wilayah" required>
                                            <option value="{{ $jamaah->wilayah->id }}">{{ $jamaah->wilayah->nama_wilayah
                                                }}</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mt-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @enderror" name="foto" value="{{ old('foto')??$jamaah->foto }}">
                                        @error('foto')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <img src="{{ asset('assets/images/jamaah/foto/'.$jamaah->foto) }}" width="100"
                                        class="img-thumbnail">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mt-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @enderror" name="ktp" value="{{ old('ktp')??$jamaah->ktp }}">
                                        @error('ktp')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <img src="{{ asset('assets/images/jamaah/ktp/'.$jamaah->ktp) }}" width="100"
                                        class="img-thumbnail">
                                </div>
                            </div>
                        </div>
